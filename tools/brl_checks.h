 ...
 * @param typeform (optional) the typeform input for forward translation, or the expected
 * typeform output for backward translation. If not specified it defaults to NULL.
